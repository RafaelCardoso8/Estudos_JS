; (function () {
	...
	function Task(name, completed, createdAt, updatedAt){
        ...
        //  - createdAt - times tamp - opcional, timestamp atual é o valor default) 
        ...
        if(! name){
            throw new Error("Erro: informe o parâmetro name")
        }

        this.name = name //parametro pedido na criação do objeto
        this.completed = completed || false // curto circuito no false 
    ...
    function addTask(taskName) {
        // adicione uma nova instancia de 
